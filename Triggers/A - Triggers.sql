...
- Performing complex validations that cannot be done with ordinary CHECK constraints or other constraints.
  For example, I might need to compare something in this table with some other set of information from multiple tables, or against some aggregates.
...
-- We have a complex business rule than the check constraint
